 ...
 */
final class Version20210221173158 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eleve CHANGE select_eleve select_eleve TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eleve CHANGE select_eleve select_eleve TINYINT(1) NOT NULL');
    }
}
